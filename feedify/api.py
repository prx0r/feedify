    ...
    with SessionLocal() as session:
        ...
        for s in rows:
            ...
            results.append({
                ...
                "is_convergence": score_result["is_convergence"],
                "breakdown": score_result["breakdown"],
                "quantum_terms": score_result["quantum_terms"],
                "agi_terms": score_result["agi_terms"],
                "regime_terms": score_result["regime_terms"],
